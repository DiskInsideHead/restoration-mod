...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Skills", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["mutator_letthesleepinggoddie_longdesc"] = "You will lose the ammo currently loaded in your weapon after non-empty reloads; weapons that retain their ammo for their reload as well as reloads triggered by skills are exempt from the effects of this mutator.",
