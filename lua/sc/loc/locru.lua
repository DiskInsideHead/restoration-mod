        ...
        LocalizationManager:add_localized_strings(
            {
                ...
                ["restoration_level_data_ahopl"]            = "21:06, Частный клуб Юрия", --A House of Pleasure"
                ["restoration_level_data_atocl"]            = "19:03, Вечеринка в Пентхаусе", --A Touch of Class"
                ["restoration_level_data_rusdl"]            = "10:23, Ювелирный магазин 'Гарнет Групп'", --Cold Stones"
                ["restoration_level_data_crimepunishlvl"]   = "13:19, Исправительное учреждение где-то в России", --Crime and Punishment"
                ["restoration_level_data_deadcargol"]       = "20:36, Канализация", --Deadly Cargo"
                ["restoration_level_data_hunter_party"]     = "15:56, Пентхаус Николая", --Hunter and Hunted d1"
                ["restoration_level_data_hunter_departure"] = "10:13, Частный аэропорт Александра", --Hunger and Hunted d2"
                ["restoration_level_data_hunter_fall"]      = "1:36, Где-то над международными водами", --Hunter and Hunted d3"
                ["restoration_level_data_ruswl"]            = "11:50, Где-то в России", --Scorched Earth"

				--Я устал это немного переводить по этому потом [[--TO RU--]]
				["restoration_level_data_jambank"]                = "11:59 AM, Банк Harvest & Trustee", --Botched Bank
				["restoration_level_data_2Fort"]                  = "Overime, Somewhere in Teufort", --2fort
				["restoration_level_data_anlh"]                   = "14:35, Вилла Цзянь Ляна", --An End to Liang
				["restoration_level_data_lvl_fourmorestores"]     = "15:12, Магазины", --Four More Stores
				["restoration_level_data_TonCont"]                = "11:01, Атриум", --AT: Atrium
				["restoration_level_data_amsdeal1"]               = "21:49, Переулки", --Armsdeal Alleyway
				["restoration_level_data_ascension_III"]          = "22:53, Исследовательский центр 'Эклипс'", --Ascension
				["restoration_level_data_hwu"]                    = "23:03, Склад компании 'Авалон Лоджистикс'", --Avalon's Shadow
				["restoration_level_data_vrc1"]                   = "14:35, Центр города", --A Very Richie Christmas d1
				["restoration_level_data_vrc2"]                   = "18:46, Складское помещение", --A Very Richie Christmas d2
				["restoration_level_data_vrc3"]                   = "23:04, Башня GENSEC", --A Very Richie Christmas d3
				["restoration_level_data_btms"]                   = "4:40, Невада - объект «Блэк Ридж", --Blackridge Facility
				["restoration_level_data_BloodMoney"]             = "20:00, Офисы", --Blood Money
				["restoration_level_data_brb_rant"]               = "18:53, Нью-Йорк, Бруклин, Филиал банка Harvest & Trustee", --Brooklyn Bank Ranted
				["restoration_level_data_lit1"]                   = "16:20, Калифорния, Магазин 'Зелени'", --California Heat???
				["restoration_level_data_lit2"]                   = "16:20, Калифорния, Магазин игр Альмира", --California Heat - Almir's Games
				["restoration_level_data_dwn1"]                   = "19:12, Калифорнии, 'Зеленое' депо", --Deep Inside
				["restoration_level_data_the_factory"]            = "21:37, Исследовательский центр 'Эклипс'", --Eclipse Research Facility
				["restoration_level_data_Election_Funds"]         = "10:29, Избирательный штаб", --Election Funds
				["restoration_level_data_constantine_mex_level"]  = "15:46, Где-то в Мексике", --End of an Era
				["restoration_level_data_battlearena"]            = "11:14, Джорджтаун", --FiveG
				["restoration_level_data_funbank"]                = "Что-то здесь не так...", --Funbank
				["restoration_level_data_RogueCompany"]           = "20:20, Территория шакалов", --Rogue Company
				["restoration_level_data_bnktower"]               = "ВРЕМЯ ЗАСЕКРЕЧЕНО, У.Л.Е.Й. GenSec", --GenSec HIVE
				["restoration_level_data_glb"]                    = "11:19, Банк Золотой Лотос", --Golden Lotus Bank
				["restoration_level_data_constantine_harbor_lvl"] = "21:12, Склады верфи", --Harboring a Grudge
				["restoration_level_data_tonmapjam22l"]           = "4:49 PM, Банк Harvest & Trustee", --Hard Cash
				["restoration_level_data_hardware_store"]         = "7:36 PM, Hardware Store", --Hardware Store
				["restoration_level_data_tj_htsb"]                = "13:10, Банк Harvest & Trustee", --H&T Southern Branch
				["restoration_level_data_tj_htsb_escape_level"]   = "Беги!", --H&T Southern Branch escape day? probably unused, dunno
				["restoration_level_data_hntn"]                   = "09:16, Банк Harvest & Trustee", --H&T Northern Branch
				["restoration_level_data_hidden_vault"]           = "11:08, Объект компании Кранич", --Hidden Vault
				["restoration_level_data_crumch_returns"]         = "12:50, Shield Mall", --Mallcrasher Ranted
				["restoration_level_data_mansion_stage1"]         = "02:13 , Особняк Сэра Элмсворта", --Elmsworth Mansion
				["restoration_level_data_skm_nmh"]                = "21:12, Mercy Hospital - Крыша", --No Mercy SKM
				["restoration_level_data_office_strike"]          = "13:57, Офис ФБР", --Office Strike
				["restoration_level_data_highrise_stage1"]        = "1:03, Апартаменты Тремблей", --Out of Frame
				["restoration_level_data_constantine_bank_lvl"]   = "12:00, Тихоокеанский банк", --Pacific Bank
				["restoration_level_data_sh_raiders"]             = "17:16, Окраинное хранилище", --Safehouse Raiders
				["restoration_level_data_santas_hardware_store"]  = "15:47, Магазин бытовой техники", --Santa's Hardware Store
				["restoration_level_data_schl"]                   = "21:57, Клуб «Scarlet»", --Scarlet Club
				["restoration_level_data_skm_wd2_x"]              = "18:09, Логистический док Альмендия", --Watchdogs d2 SKM revamp
				["restoration_level_data_Skyscraper"]             = "2:13, штаб-квартира компании GenSec", --Skyscraper Heist
				["restoration_level_data_tonisl1"]                = "15:31, Банк Harvest & Trustee", --Grand Harvest
				["restoration_level_data_ttr_yct_lvl"]            = "14:19, Яхта Вэй Чэна", --Triad Takedown Remastered
				["restoration_level_data_Tonis2"]                 = "13:31, Портовые склады", --Triple Threat
				["restoration_level_data_trop"]                   = "11:48, Где-то над международными водами", --Tropical Treasure
				["restoration_level_data_Gambling_room"]          = "21:29, Магазин «24/7", --Underground Bargains
				["restoration_level_data_finsternis"]             = "17:24, Германия - Шварцвальд»", --Projekt Finsternis
        ...
        LocalizationManager:add_localized_strings(
            {
				...
				["bm_wp_upg_a_piercing_semi_desc_sc"]                       = "12 флешеттов, которые #{skill_color}#пробивают броню##.",
				["bm_wp_upg_a_piercing_pump_desc_sc"]                       = "12 флешеттов, которые #{skill_color}#пробивают броню##.",
				["bm_wp_upg_a_piercing_heavy_desc_sc"]                      = "12 флешеттов, которые #{skill_color}#пробивают броню##.",
				...
				["bm_wp_upg_o_2_szholot"]                                   = "Голографический прицел с тепловизором.\n#{risk}#Увеличение 2x.##\n#{skill_color}#Автоматически помечает## охранников, элитных и особых врагов при прицеливании.\n\n#{risk}#Охранники помечаются только в стелсе.##",
                ...
                --Batshit insane
				["bm_melee_bat_info"]                                       = "Бейсбольная бита, не больше и не меньше.\n\nОбычный спортивный инвентарь в руках нужного человека превращается в грозное оружие.\n\nАтаки заряжаются на #{skill_color}#25%## быстрее, позволяя крушить черепа быстрее чем обычно!.",
                --Machete
                ...
                --Briefcase
				["bm_melee_briefcase_info"]                                 = "Загадочный чемодан с не менее загадочным содержимым.\nХодят слухи, что внутри лежат некие 'Бипки'.\n\nУменьшает получаемый урон на #{skill_color}#10%## во время замаха.", --Briefcase"
                --Toasty
				...
				["bm_melee_number_3_info"]                                  = "\"Если вы готовы убить за свои идеалы, то наверняка готовы и умереть за них!\"\n\nБег запускает атаку, которая наносит #{skill_color}#45## секунд каждые #{skill_color}#0.4## секунды врагам, на которых вы бежите. Навыки позволяют увеличить этот урон.\n\nПопадание по врагу во время бега тратит #{important_1}#15% стамины##, убийство врага возвращает #{skill_color}#10%##.\n\n#{important_1}#Не позволяет парировать атаки.##",
                ...
                --Crook
				["bm_melee_stick"]                                          = "Пастушеский посох ",
				["bm_melee_stick_info"]                                     = "Устали после долгого ограбления? Хотите выглядеть старым и мудрым? Может, разбить морду полицейскому? Пастушеский посох может все.",
                --Pounder Nailgun
				...
				["bm_melee_wing_info"]                                      = "Хорошо подходит к набору маскировки!\n\nНаносит #{skill_color}#четырехкратный## урон при атаке сзади.",
                 -- Wing Butterfly Knife"
                --PICKLE
                ...
                --fishe
				["bm_melee_holy_mackerel_info"]                             = "#{item_stage_2}#РЫБА 42 УРОВНЯ##\n\nБыть избитым рыбой, должно быть, унизительно",
				--Rezkoye
				["bm_melee_oxide_info"]                                     = "Легендарное мачете НКВД - это произведение искусства от Кизлярских мастеров, которые уже долгие годы радуют своих поклонников качественными изделиями. Лезвие изготовлено из нержавеющей стали 3Cr13, благодаря чему оно обладает высокой прочностью и долговечностью.\n",
                ...
                --[[--TO RU--]]
				["bm_wskn_resmod_ownthiscity_desc"]                         = "It's our time now! Let's get this shit started!", --Настало наше времечко! АЙДА! ГОЙДА! вот бы на такое поменять
				...
				["bm_menu_damage"]                                          = "Урон", -- I gotta find out WHO KILLED MY DA- how to spoof the damage readout for melee "
...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization_Weapons", function(loc)
        LocalizationManager:add_localized_strings(
            {
				...
				["bm_wp_wpn_fps_upg_triad_bullets_44normal_desc"]         = "Зачем использовать устаревшие боеприпасы после столкновения с чи-револьверами? Почему, блядь, собаки лижут свои яйца?\nМинимальный и максимальный подбор патронов: 1.33x",
				["bm_wp_wpn_fps_upg_triad_bullets_44ap_desc"]             = "С помощью этих снарядов вы сможете пробивать стены, броню и щиты врагов.\nПозволяет пробивать броню, щит и стену за счет урона.",
				["bm_wp_wpn_fps_upg_triad_bullets_44hollow_desc"]         = "Пиздатые патроны, украденные неизвестно откуда. Единственное, что вам нужно знать, это то, что эти хуевины рвут все на своем пути. Ахуенно да?\nПатроны редкие и найти их сложнее.\nМинимальный и максимальный подбор патронов: 0.33x",
                --DECK-ARD [Custom]--
				["bm_wp_wpn_fps_upg_deckard_ammo_damage_high_desc"]       = "Пристрели их так, чтобы они умерли и в аду.\nОромный урон за цену всего остального.\nПробивает броню, щиты, стены и врагов.\nПатроны редкие и найти их сложнее.\nМинимальный и максимальный подбор патронов: 0.33x",
				["bm_wp_wpn_fps_upg_deckard_ammo_damage_med_desc"]        = "Стреляй пока не умрут!\nПатроны проще найти.\nМинимальный и максимальный подбор патронов: 1.33x",
                --Unknown Weapon--
				["bm_wp_wpn_fps_ass_tilt_a_fuerte"]                       = "Конверсия под 7.62mm",
				["bm_wp_wpn_fps_ass_tilt_a_fuerte_desc"]                  = "Конверсия калибра под 7.62mm. Немного уменьшает стабильнось и скорострельность, но увеличивает урон и точность.",
                --MK18 Specialist [Custom]--
				["bm_wp_wpn_fps_ass_mk18s_a_weak_desc"]                   = "Боеприпасы, чем-то похожие на таковые у винтовок среднего класса. Стабильности и боезапаса меньше, но урон и точность увеличенны.",
				["bm_wp_wpn_fps_ass_mk18s_vg_magwell"]                    = "Magwell Grip",
                --Unknown Weapon--
				["bm_wp_wpn_fps_pis_noodle_m_8"]                          = "Увеличенный магазин",
				["bm_wp_wpn_fps_pis_noodle_m_10"]                         = "Extend-o Magazine", -- А как обыграть
                --Jackal SMG(these are unused though)--
				["bm_wp_wpn_fps_upg_schakal_m_atai_desc"]                 = "Превращает Шакала в Мастифа, младшей в роду шакалов. Не так стабилен, как Койот, и не так смертоносен, как Шакал, но, по крайней мере, способнен пробивать и броню, и стены.",
                --Unknown weapon--
				["bm_wp_wpn_fps_upg_am_hollow_large_desc"]                = "Патроны с открытым наконечником, которые благодаря физике создают более крупные и болезненные раны во врагах. Хотя патроны HP труднее найти и у них больше отдача, но выше точность и урон в голову.",
                --Unknown Weapon--
				["bm_menu_weirdmagthing"]                                 = "Magwell Grip",
                --Gecko 7.62--
				["bm_wp_wpn_fps_ass_galil_m_drum"]                        = "Барабан на 75 патронов",
                --Cavity 9mm--
				["bm_wp_wpn_fps_smg_calico_body_full_desc"]               = "Конверсия пистолета.\nМинимальный и максимальный подбор патронов: 0.8x",
                --DP-28 [Custom]--
				["bm_wp_wpn_fps_lmg_dp28_tripod_top_desc"]                = "Тренога с дополнительными патронами, установленная на боку.\nСкорость передвижения снижается на 20%",
                --Arbiter--
				["bm_wp_wpn_fps_gre_arbiter_o_smart_desc"]                = "Экспериментальный прицел, обеспечивающий Арбитру возможности воздушного взрыва.\nНесовместим с зажигательными патронами.", --this weapon mod isn't vanilla though iirc--"
                --Itachi [Custom]--
				["bm_wp_wpn_fps_upg_bajur_m_pants"]                       = "НЕЕТ",
				["bm_wp_wpn_fps_upg_bajur_fg_dmr_desc"]                   = "Заменяет верхнюю часть ствольной коробки «Итачи» на вариант «Беовульфа» калибра .50, благодаря чему оружие бьет намного сильнее.\nУменьшает все показатели, кроме точности и урона.",
                --Bipod--
				...
				["bm_grenade_damage_control"]                             = "Фляга",
                ...
                --M6D
				["halo_scope"]                                            = "Прицел Smart-Link",
				["halo_scope_2_desc"]                                     = "Подключает вашу маску к системе #{skill_color}#Smart-Link## прицелом.\n#{risk}#Увеличение 2x.##",
                --M200 WIDOWMAKER
				...
				["bm_beer_auto_desc"]                                     = "Практически фантастический пистолет с автоматическим режимом огня. Живой или мертвый, ты пройдешь со мной.",
                --Contractor Pistols
                ...
                --Kahn .357
				["bm_korth_r8"]                                           = "#{skill_color}#Наносит на 100% больше урона в голову всем противникам, кроме капитанов.##",
                --Matever 2006m
                ...
                --REDACTED
				["bm_w_redacted_desc_sc"]                                 = "#{stats_positive}#REDACTED##\n\n#{risk}#Это оружие стреляет очередями по 2 патрона при стрельбе от бедра и в полуавтоматическом режиме при прицельной.##",
                --[[ MGs ]]
                --Bootleg/HK416c
				...
				["bm_wp_saiga_m_20rnd"]                                   = "Барабан на 20 патронов",
                --AA12
                ...
                --Widowmaker TX
				["bm_wp_wpn_fps_shot_wmtx_mag_ext"]                       = "Увеличенный магазин",
				["bm_wp_wpn_fps_upg_wmtx_gastube_burst"]                  = "Стрельба очередями",
				["bm_wp_wpn_fps_upg_wmtx_gastube_burst_desc"]             = "Реализует возможность переключения на ##{skill_color}#стрельбу очередямии по два патрона##.",
                --[[ ARs ]]
                --S552
				...
				["bm_wp_m4_m_drum"]                                       = "Барабан на 100 патронов",
                --AK5
				...
				["bm_asval_spp_sc_desc"]                                  = "Обычным людям нравятся обычные винтовки, но кто-то хочет чего-то особенного.\n\nОбладает #{skill_color}#встроенным глушителем## и #{skill_color}#может пробивать бронежилеты, врагов, щиты в пределах максимального расстояния и тонкие стены.##",
				["bm_wp_upg_i_asval_spp"]                                 = "Valkyria SPP-ecial",
				["bm_wp_upg_i_asval_spp_desc"]                            = "Позволяет использовать бронебойные боеприпасы, которые могут #{skill_color}#пробивать броню, нескольких врагов, щиты в пределах максимального расстояния и тонкие стены.##",
                --Galil
                ...
                --[[--TO RU--]]
				["bm_scarhamr_sc_desc"]                                   = "Пехотная автоматическая винтовка будущего... или нет.",
                ...
                --BOCW EM2
				["bm_w_t9british"]                                        = "EM2",
				["bm_wp_wpn_fps_ass_t9british_xmag_01"]                   = "30 Rnd Mag",
                ...
                --[[--TO RU--]]
				["bm_w_bulldog_desc"]                                     = "Счастье в том, чтобы уничтожать врагов с помощью 'Бульдога'.\n\n#{risk}#Стреляет в автоматическом режиме при стрельбе от бедра и очередями при прицельной стрельбе.##",
                ...
                --SHAKAL
				["bm_schakal_sc_desc"]                                    = "Немецкий ПП созданный для различных силовых структур США. Является более современной и дешевой альтернативой Компакт-5. Полицейские точно оценят его в ваших руках!",


                --McShay Mod Pack MODS--
				["bm_wp_ak_upg_fg_zenitco"]                               = "Цевье 'Taktika'",
				["bm_wp_ak_upg_dh_zenitco"]                               = "Рукоятка взвода 'Taktika'",
				...
				["bm_wp_tkb_bolt_rp4"]                                    = "Рукоятка взвода 'Taktika Deluxe'",
				["bm_wp_tkb_body_pouch"]                                  = "Подсумок для боеприпасов",
				["bm_wp_tkb_m_bakelite"]                                  = "Быстрый сибирский магазин",
				["bm_wp_tkb_s_tigr"]                                      = "Наплечник",


				["bm_wp_tkb_conversion"]                                  = "Эксклюзивный набор стрелка",
				["bm_wp_tkb_conversion_desc"]                             = "Эксклюзивный набор пересобирает винтовку в стиле Пост-Апокалипсиса\n\nИнтересный факт - Этот набор никак не связан со #{skill_color}#Стрелком##!",
            }
        )
            ...
            LocalizationManager:add_localized_strings(
                {
                    ...
                    -- Я аниме тоже не смотрю поетому анимешны отсылки отключенны!!!!
            ...
            LocalizationManager:add_localized_strings(
                {
					...
					["bm_w_g3_hk33"]          = "H&K HK33",
					["bm_w_g3_hk33_fo3"]      = "Р91",
					["bm_g3_sc_desc"]         = 'Тут должена была быть отсылка к аниме "Пострелушки! / Upotte!!", но я его не смотрел.\n#{skill_color}#И ВАМ НЕ СОВЕТУЮ.##',
					["bm_g3_ap25_sc_desc"]    = "Старшая сестра Компакт-5 и Бреннера-21, не уступает по точности снайперским винтовкам.\n\n#{skill_color}#Наносит 75% урона через броню и может пробивать врагов.##",
					["bm_menu_jiisuri_stock"] = "Колготки",
                }
            )
        end
        ...
        if shitpost or not easterless and big <= pistol then
            LocalizationManager:add_localized_strings(
                {
                    ["bm_w_huntsman"]    = "Афтамат Москони 5Г",
                    ["bm_w_deagle"]      = "БОЛЬШОЙ пистолет",
                    ["bm_w_m16"]         = weapon_names == 2 and "Ну да, это FAMAS!" or "Ну да, это CLARION!",
                    ["bm_m16_sc_desc"]   = "Я дам тебе патроны, а ты постарайся кого нибудь убить, хорошо?",
                    ["bm_w_x_type54"]    = weapon_names == 2 and "Близняшки" or "Две балерины",
                    ["bm_akmsu_sc_desc"] = "А #{stat_maxed}#МАЛЬЧИШЕК## мочить #{stat_maxed}#СИМПАТИЧНЫХ## будем? Не стоит недооценивать эту винтовку, она способна вытащить из любой ситуации."
                }
            )
        end
        ...
        local mypersonalbrainrot = math.rand(1)
        local mypersonalbigdoogs = 0.02
        if Month == "4" and Day == "1" then
        ...
        if not easterless and mypersonalbrainrot <= mypersonalbigdoogs then
            LocalizationManager:add_localized_strings(
                {
                	--Амарок 900
	                ["bm_w_awp"]                       = "ВИНТОВКА ДРАНОН ЛОРА",
	                ["bm_awp_sc_desc"]                 = "Обычная винтовка АВП без рисунка дранон лора, который играть не умеет и игры руинит постоянно.\n\n#{skill_color}#Если попадать, то может пробивать броню, врагов, щиты и тонкие стены.##",
	                ["bm_awp_cs_dragon"]               = "ТОЧНО НЕ ВИНТОВКА ДРАНОН ЛОРА",
	                ["bm_awp_cs"]                      = "ВИНТОВКА ДРАНОН ЛОРА",
	                ["bm_wp_upg_bazooka"]              = "ВИНТОВКА ДРАГОН ЛОРА (украли)",
	                ["bm_wp_upg_bazooka_desc"]         = "ЛЕГЕНДАРНАЯ ВИНТОВКА ДРАНОН ЛОРА.\nКруто! Прямо как в контер страйке!'.\n\n#{skill_color}#Позволяет пробивать титановые щиты.##\n\n#{risk}#После выстрела Вы выходите из режима прицеливания.##",
	                ["bm_bazooka_sc_desc"]             = "ЛЕГЕНДАРНАЯ ВИНТОВКА ДРАНОН ЛОРА.\nКруто! Прямо как в контер страйке!'.\n\n#{skill_color}#Позволяет пробивать титановые щиты.##\n\n#{risk}#После выстрела Вы выходите из режима прицеливания.##",
                    --Туз-Пик
	                ["bm_wpn_prj_ace"]                 = "Карты ( Разложены в другом порядке )",
	                ["bm_wpn_prj_ace_desc"]            = "Как они могут быть там разложены в другом порядке?\nВы чё, в киосках их заряжаете?!\n",
                    --Фляга
	                ["bm_grenade_damage_control"]      = "Литр Энжера",
	                ["bm_grenade_damage_control_desc"] = "Странная инопланетная жидкость с еще более странным эффектом.\nДанный напиток #{skill_color}#ТОЧНО## не содержит краситель Е110 'жёлтый солнечный закат', который #{skill_color}#ТОЧНО## не вызывает лимфому, повреждение мозга, аллергию, рвоту и негативное влияние на внимание и концентрацию детей.",
                }
            )
        end
        ...
        LocalizationManager:add_localized_strings(
            {
                ...
                --[[--TO RU--]]
				["loading_captains_res_13"]                          = "Капитан Винтерс может ослепить вас своим щитом, подобно Титановым. Только имейте в виду, что его световая панель не ломаются.",
                --Stealth Hints
				...
				["mutator_fatroll"]                                  = "Лютый троллинг",
	                --[[--TO RU--]]
				["menu_mutator_fatroll"]                             = "Грейс период (в секундах)",
				...
				["mutator_thecandlesburnoutforyou"]                  = "Марафон перезарядок",
				                --[[--TO RU--]]
				["mutator_thecandlesburnoutforyou_desc"]             = "Отключает автоматическую перезарядку после опустошении магазина.",
				                --[[--TO RU--]]
				["mutator_thecandlesburnoutforyou_longdesc"]         = "Отключает автоматическую перезарядку после опустошении магазина; На перезарядку придется нажимать своими ручками",

				                --[[--TO RU--]]
				["mutator_letthesleepinggoddie"]                     = "Магазин Мученника",
				                --[[--TO RU--]]
				["mutator_letthesleepinggoddie_desc"]                = "При перезарядке магазина, в котором есть патроны, они испаряются...",
				                --[[--TO RU--]]
				["mutator_letthesleepinggoddie_longdesc"]            = "При перезарядке магазина, в котором есть патроны, они испаряются.\n\nПримечание: Оружие, сохраняющее патроны во время перезарядки (перезарядка одиного патрона, тактическая перезарядка (?) и т. д.), а также перезарядка, вызванная умениями, не подпадает под действие этого мутатора..",
				                --[[--TO RU--]]
				["mutator_letthesleepinggoddie_no_effect"]           = "Не подвержен влиянию мутатора \"Магазин Мученника\".",
				...
				["menu_crew_eager_desc"]                             = "Игроки перезаряжают оружие на 10% быстрее.",
                 ...
                 --
                 --
                --[[   SKILLTREES   ]] --[[   MASTERMIND   ]] --[[   MEDIC SUBTREE   ]] --Combat Medic
				...
				["menu_body_expertise_beta_desc_sc"]                 = "БАЗОВЫЙ: #{owned}#$basic##\n#{skill_color}#Все оружие## наносит #{skill_color}#$skill_value_b1## урона через броню.\n\nЭтот эффект увеличивается до #{skill_color}#$skill_value_b2## для #{skill_color}#пулеметов.##\n\n#{risk}#Эффект складывается с бронебойностью вашего оружия, до максимальных 100%.##\n\nПИКОВЫЙ: #{owned}#$pro##\nУбийства из #{skill_color}#пулеметов## в течение одной очереди дольше #{skill_color}#$skill_value_p1## секунд увеличат урон на #{skill_color}#$skill_value_p2##; складывается до #{skill_color}#$skill_value_p3## раз.",
                 --
                 --
                --[[   ENFORCER   ]] --[[   SHOTGUNNER SUBTREE   ]] --Underdog--
				...
				["menu_overkill_desc_sc"]                            = "БАЗОВЫЙ: #{owned}#$basic##\nУбийство из #{skill_color}#дробовика, огнемета или пилы OVE9000## увеличивает их урон на #{skill_color}#$skill_value_b1## на #{skill_color}#$skill_value_b2## секунды, если они были выполнены до начала #{skill_color}#падения урона##.\n\n#{risk}#Навык не сработает, если противник был убит## #{important_1}#взрывом или уроном-через-время.##\n\nПИКОВЫЙ: #{owned}#$pro##\nБонус к урону теперь работает на все оружие и действует #{skill_color}#$skill_value_p1## секунд. Навык должен быть активирован убийством из #{skill_color}#дробовика, огнемета или пилы OVE9000.##\n\n#{risk}#Бонус не работает на гранатометы и ракетометы.##\n\nВы убираете и достаете #{skill_color}#дробовики, огнеметы и пилу## на #{skill_color}#$skill_value_p2## быстрее.",
                 --
                --[[   JUGGERNAUT SUBTREE   ]] --Stun Resistance--
				...
				["menu_bandoliers_desc_sc"]                          = "БАЗОВЫЙ: #{owned}#$basic##\nВаш общий запас патронов увеличен на #{skill_color}#$skill_value_b1.##\n\nПИКОВЫЙ: #{owned}#$pro##\nВы подбираете на #{skill_color}#$skill_value_p1## больше патронов из коробочек.\n\nВаш шанс получить метательное оружие из коробочки патронов увеличено на #{skill_color}#$skill_value_p2##; шанс увеличивается еще на #{skill_color}#$skill_value_p3## за каждый подбор. Шанс обнуляется, когда вы получаете метательное оружие из коробочки.\n\n#{risk}#Не работает на метательное оружие из перков.##",
                 --
                 --
                --[[   TECHNICIAN   ]] --[[   FORTRESS SUBTREE   ]] --Logistician
				...
				["menu_iron_man_desc_sc"]                            = "БАЗОВЫЙ: #{owned}#$basic##\nВашу броню теперь нельзя прошить.\n\nПИКОВЫЙ: #{owned}#$pro##\nПока ваша броня полностью заполнена, любой полученный урон уменьшится на число, равное #{skill_color}#$skill_value_p1## от вашей максимальной брони.\n\nВаша броня восстанавливается на #{skill_color}#$skill_value_p2## быстрее. $anarc_disable",
                 --
                --[[   BREACHER SUBTREE   ]] --Silent Drilling--
				...
				["menu_fire_trap_beta_desc_sc"]                      = "БАЗОВЫЙ: #{owned}#$basic##\nВы получаете возможность чинить дрель или пилу ударом холодного оружия.\n\nУ вас #{skill_color}#1## попытка на каждую поломку с шансом #{skill_color}#75%.##\n\nПИКОВЫЙ: #{owned}#$pro##\nВы #{skill_color}#больше не убираете оружие при взаимодействии.##\n\nВы можете оглядываться, приседать, двигаться, целиться и использовать оружие, пока держите кнопку и остаетесь в зоне взаимодействия.",
                 --
                --[[   COMBAT ENGINEER SUBTREE   ]] --Sharpshooter--
				...
				["menu_ecm_2x_beta_desc_sc"]                         = "БАЗОВЫЙ: #{owned}#$basic##\nВраги, отмеченные вами, получают на #{skill_color}#$skill_value_b1## больше урона на расстоянии дальше #{skill_color}#$skill_value_b2## метров.\n\nПИКОВЫЙ: #{owned}#$pro##\nВраги, отмеченные вами, получают на #{skill_color}#35%## больше урона с любого расстояния, от любого оружия.",
                 --
                --[[   ARTFUL DODGER SUBTREE   ]] --Duck and Cover--
				...
				["menu_jail_diet_beta_desc_sc"]                      = "БАЗОВЫЙ: #{owned}#$basic##\nВы получаете #{skill_color}#$skill_value_b1## очко уворота за каждые #{skill_color}#$skill_value_b2## очка нагрузки ниже #{skill_color}#$skill_value_b3## до максимальных #{skill_color}#$skill_value_b4## уворота.\n\nПИКОВЫЙ: #{owned}#$pro##\nВы получаете #{skill_color}#$skill_value_b1## очко уворота за каждое #{skill_color}#$skill_value_p1## очко нагрузки ниже #{skill_color}#$skill_value_b3## до максимальных #{skill_color}#$skill_value_b4## уворота.\n\nКогда ваша броня ломается, уворот от атаки восстанавливает #{skill_color}#$skill_value_p2## вашего здоровья. Это может произойти только один раз, пока ваша броня снова не сломается.",
                 --
                --[[   CONTRACT KILLER SUBTREE   ]] --FORMERLY "SILENT KILLER"
                --Second Wind
				...
				["menu_unseen_strike_beta_desc_sc"]                  = "БАЗОВЫЙ: #{owned}#$basic##\nВы получаете #{skill_color}#$skill_value_b1## шанс критического попадания за каждые #{skill_color}#$skill_value_b2## очка нагрузки ниже #{skill_color}#$skill_value_b3##, до максимального шанса #{skill_color}#$skill_value_b4.##\n\nКритические попадания наносят на #{skill_color}#50%## больше урона.\n\nПИКОВЫЙ: #{owned}#$pro##\nВы получаете #{skill_color}#$skill_value_p1## шанс критического попадания за каждое #{skill_color}#$skill_value_p2## очко нагрузки ниже #{skill_color}#$skill_value_p3##, до максимального шанса #{skill_color}#$skill_value_p4.##\n\nВаш шанс критического попадания увеличивается на #{skill_color}#$skill_value_p5## при атаках сзади.",
                 --
                 --
                --[[   FUGITIVE   ]] --[[   GUNSLINGER SUBTREE   ]] --Equilibrium--
				...
				["menu_trigger_happy_beta_desc_sc"]                  = "БАЗОВЫЙ: #{owned}#$basic##\nКаждый выстрел в голову из #{skill_color}#пистолета## дает дополнительные #{skill_color}#$skill_value_b1## урона на #{skill_color}#$skill_value_b2## секунды. Этот эффект накладывается до #{skill_color}#$skill_value_b3## раз, а длительность обновляется при каждом выстреле в голову.\n\nПИКОВЫЙ: #{owned}#$pro##\nУвеличивает длительность бонуса к урону до #{skill_color}#$skill_value_p1## секунд. Эффект теперь накладывается еще #{skill_color}#$skill_value_p2## раз.",
                 --
                --[[   REVENANT SUBTREE   ]] --Running From Death--
        ...
        LocalizationManager:add_localized_strings(
            {
                ...
                --Anarchist--
                --[[--TO RU--]]
				["menu_st_spec_15"]               = "Анархист", --there's a random space at the end of the original string
