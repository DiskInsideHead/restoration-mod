...
Hooks:Add("LocalizationManagerPostInit", "SC_Localization", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["bm_asval_spp_sc_desc"] = "Обычным людям нравятся обычные винтовки, но кто-то хочет чего-то особенного.\n\nОбладает #{skill_color}#встроенным глушителем## and #{skill_color}#может пробивать бронежилеты, врагов, щиты в пределах максимального расстояния и тонкие стены.##",
		["bm_wp_upg_i_asval_spp"] = "Valkyria SPP-ecial",
		["bm_wp_upg_i_asval_spp_desc"] = "Продвинутые компоненты винтовки в сочетании с бронебойными боеприпасами, которые могут #{skill_color}#пробивать броню, нескольких врагов, щиты в пределах максимального расстояния и тонкие стены.##",
		--Galil
